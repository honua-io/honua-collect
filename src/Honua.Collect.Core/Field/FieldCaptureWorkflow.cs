...
/// <summary>
/// Product adapter over SDK-owned field form, validation, workflow, and
/// duplicate-detection contracts. Ported from the former
/// <c>Honua.Mobile.Field</c> package; consumes <c>Honua.Sdk.Field</c> directly.
/// </summary>
public sealed class FieldCaptureWorkflow
{
    private readonly DuplicateDetector _duplicateDetector;

    /// <summary>Initializes a new field capture workflow adapter.</summary>
    /// <param name="duplicateDetector">SDK duplicate detector.</param>
    public FieldCaptureWorkflow(DuplicateDetector duplicateDetector)
    {
        _duplicateDetector = duplicateDetector ?? throw new ArgumentNullException(nameof(duplicateDetector));
    }

    /// <summary>Applies SDK calculated field expressions to the record.</summary>
    ...
    /// <summary>Validates a record against an SDK field form definition.</summary>
    /// <param name="form">SDK field form definition.</param>
    /// <param name="record">SDK field record.</param>
    ...
    /// <summary>Determines whether a record can move between SDK workflow statuses.</summary>
    ...
    /// <summary>Transitions an SDK field record and updates workflow timestamps.</summary>
    /// <param name="record">SDK field record.</param>
    ...
    /// <summary>Finds duplicate SDK field records using the SDK duplicate detector.</summary>
